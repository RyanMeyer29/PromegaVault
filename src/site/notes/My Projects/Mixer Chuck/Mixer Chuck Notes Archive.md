...
This note preserves the historical working notes, meeting logs, and intermediate state from the [[My Projects/Mixer Chuck/Mixer Chuck\|Mixer Chuck]] project. It exists so the current project note stays clean while the full record of how things developed is not lost. See [[My Projects/Mixer Chuck/Mixer Chuck\|Mixer Chuck]] for the current state.
