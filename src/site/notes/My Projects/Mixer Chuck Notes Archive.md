---
{"dg-publish":true,"permalink":"/my-projects/mixer-chuck-notes-archive/","tags":["My-Projects"],"dg-note-properties":{"aliases":["Mixer Chuck Archive"],"tags":["My-Projects"],"source":"personal_notes","last_updated":"2026-04-29"}}
---

#My-Projects

This note preserves the historical working notes, meeting logs, and intermediate state from the [[My Projects/Mixer Chuck\|Mixer Chuck]] project. It exists so the current project note stays clean while the full record of how things developed is not lost. See [[My Projects/Mixer Chuck\|Mixer Chuck]] for the current state.

---

## Historical Mixer List (pre-2026-04-29)

The original scope included 12 mixers. The EV5L25M (equipment 102978, BTC Bay 3) was later found to have been added based on misinformation and was removed from scope on 2026-04-29.
...
| Equipment # | Equipment - Desc.                 | Functional Loc. | Func. Loc. - Desc.   | Created On | Created By | BOM Component | BOM Comp. Desc.                          | Quantity |
| ----------- | --------------------------------- | --------------- | -------------------- | ---------- | ---------- | ------------- | ---------------------------------------- | -------- |
| 113417      | GMP Resin Mixer, Lightnin XSS1P33 | MAD-GMP-2210    | Small Compounding #1 | 07/30/2020 | GMCCAULE   | 500000005448  | Drive Shaft Hardware Kit (Lightnin Mixr) | 1.000    |
| 113418      | GMP Resin Mixer, Lightnin XSS1P33 | MAD-GMP-2215    | Small Compounding #2 | 07/30/2020 | GMCCAULE   | 500000005448  | Drive Shaft Hardware Kit (Lightnin Mixr) | 1.000    |
| 117266      | GMP Resin Mixer, Lightnin XSS1P33 | MAD-GMP-2232    | Compound Resin RM #3 | 11/26/2018 | GMCCAULE   | 500000005448  | Drive Shaft Hardware Kit (Lightnin Mixr) | 1.000    |
| 127950      | GMP Resin Mixer, Lightnin XSS5P33 | MAD-GMP-2224    | Large Compounding #1 | 07/12/2022 | GMCCAULE   | 500000005448  | Drive Shaft Hardware Kit (Lightnin Mixr) | 1.000    |
| 120019      | GMP Resin Mixer, Lightnin XSS1P33 | MAD-GMP-2215    | Small Compounding #2 | 07/30/2020 | GMCCAULE   | 500000005448  | Drive Shaft Hardware Kit (Lightnin Mixr) | 1.000    |

---

## Historical Chuck Body Mapping (pre-2026-04-29)

This was the state of the chuck-to-mixer mapping before styles were confirmed. Preserved here for reference.
...
| 102883      | RDC  | Style C (assumed — same model as XSS1P33 IVD units) | 1016437 / 1016438 / 1016439 |
...
Working order quantity at this stage was 18 (6 per style) plus 2 extra hardware sets for Jake's incomplete assemblies. Jake's assemblies already had chuck bodies, so no extra chucks were ordered. Stop qty was doubled since there are 2 per assembly.
...
- [x] Talk with [[People/Sean Doering\|Sean]] regarding SAP numbers for BTC mixers
- [x] Get SAP numbers for each mixer (coordinate with [[People/Garrett Tschanz\|Garrett]] for IVD mixers, [[People/Sean Doering\|Sean]] for BTC mixers)

---

## Updates (2026-03-30)

BTC urgent safety issue resolved — [[People/Travis Beyer\|Travis Beyer]] delivered a replacement chuck (Style B) to [[Buildings/BTC\|BTC]] last week per [[People/Jacob Holze\|Jake]]. [[People/Kent Toepfer\|Kent]] had flagged this as an open safety issue and was tracking status.
...
EV5L25M / Vektor V1P25M (102978) — SAP lists this as EV5L25M but the physical label reads Lightnin Vektor V1P25M. Possible the unit was replaced and SAP was never updated, or the naming convention differs. This is an open issue that needs investigation. Internally it has a different geometry than the models (slots and a set screw tab), but Travis and Ryan believe it may share the same form factor as Style C. Needs re-inspection with Jake to confirm. NOTE: this unit was subsequently removed from scope entirely on 2026-04-29 after it was confirmed to have been added based on misinformation.
...
> [!info]- Details & Notes
>
> **See also:** [[My Projects/Mixer Chuck\|Mixer Chuck]], [[People/Travis Beyer\|Travis Beyer]], [[People/Jacob Holze\|Jacob Holze]], [[People/Alex Rabbach\|Alex Rabbach]], [[People/Brian Osterbrink\|Brian Osterbrink]]
