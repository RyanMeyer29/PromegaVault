---
{"dg-publish":true,"permalink":"/definitions/parts-process/parts-process/","tags":["Definitions"],"dg-note-properties":{"aliases":["IPPP","Internally Produced Production Part"],"tags":["Definitions"],"source":"personal_notes","last_updated":"2026-04-03"}}
---
...
Request a part number from the SAP Analyst ([[People/Gary McCauley\|Gary McCauley]] as of early 2026). [[People/Nikki Masterson\|Nikki]] is also a contact for SAP part number requests. For fewer than 5 parts, use the [[Definitions/Parts Process/Parts Order Form\|Parts Order Form]] (Smartsheet) to submit the request. For 5 or more parts at once, use the [[Definitions/Parts Process/Multiple Materials Request Spreadsheet\|Multiple Materials Request Spreadsheet]] instead.
...
The [[Definitions/Quality/CoC\|CoC]] must be completed before the part is put into service. Steps:
...
Save the completed [[Definitions/Quality/CoC\|CoC]] to [[Software/EPDM\|EPDM]] in the same folder as the drawing. The CoC filename must include the part or equipment number so it is easily searchable.

### Step 5 — Deploy the Part

Once the [[Definitions/Quality/CoC\|CoC]] is uploaded to [[Software/EPDM\|EPDM]], the part can be turned over to the end user (Production). As the author/originator, it is your responsibility to remove any old parts being replaced. Confirm SAP BOMs are adjusted and any required PM plans are in place.
